...
@section('foot')
<!-- ECharts -->
<script src="{{ base_url('assets/gentelella/vendors/echarts/dist/echarts.min.js') }}"></script>
<script src="{{ base_url('assets/gentelella/vendors/echarts/map/js/world.js') }}"></script>
@endsection
